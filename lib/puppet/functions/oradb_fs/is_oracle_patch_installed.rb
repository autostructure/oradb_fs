...
Puppet::Functions.create_function(:'oradb_fs::is_oracle_patch_installed') do
  ...
  #   oradb_fs::is_oracle_patch_installed('/opt/oracle/db/','1111') => true
  ...
  def log(msg)
    Puppet::Util::Log.create(
      :level   => :info,
      :message => msg,
      :source  => 'oradb_fs::is_oracle_patch_installed'
    )
  end
