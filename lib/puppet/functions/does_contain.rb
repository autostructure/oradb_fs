...
#
 ...
 # @return [String] Return 'B', 'S', 'C', 'P', 'T', 'F' 
 ...
 #   P = at least one, but not all,  sid of the desired home from the contains_list WAS found in the desired home's sid list from search_list
 #   T = the entire sid list of the desired home from contains_list WAS found in the desired home's sid list from search_list 
 #   F = the entire sid list  of the desired home from contains_list WAS NOT found in the desired home's sid list from search_list
 # @example
 #   does_contain( Array_A, Array_B , 'home_#', '/opt/oracle/...' )=> 'B', 'S', 'C', 'P', 'T', 'F'
