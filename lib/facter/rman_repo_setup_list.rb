#/tmp/puppet_rmanrepo_db_NUM_SID
Facter.add(:rman_repo_setup_list) do
 ...
 setcode do
  ...
  command = 'ls -lQ /tmp | grep -E \"puppet_rmanrepo_db_[0-9]*_[[:alpha:]]{1}[A-Za-z0-9_\$\#]{0\,7}\"$ | awk \'$3 == "oracle" {print $9}\' | sort'
