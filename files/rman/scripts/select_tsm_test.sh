#!/usr/bin/env ksh
#
#  @(#)fs615/db/ora/rman/linux/rh/select_tsm_test.sh, ora, build6_1, build6_1a,1.1:9/5/11:15:59:05
#  VERSION:  1.1
#  DATE:  9/5/11:15:59:05
#
...
export RAO1=$TMP/select_tsm_test.1.sh
export LOG1=$LOG_DIR/select_tsm_test.1.$$.log
